<?php 
	...
	class Users extends MY_Controller{
		...
		public function index(){
			...
			$id=$this->session->userdata('inv_userid');
		...
		public function add(){
			$this->permission_check('users_add');
			$data=$this->data;//My_Controller constructor data accessed here
			$data['page_title']="Thêm mới tài khoản";
			$this->load->view('users',$data);
		}
		...
		public function view(){
			...
			$data=$this->data;//My_Controller constructor data accessed here
			$data['page_title']="Danh sách tài khoản";
		...
		public function edit($id){
		    $ids=$this->session->userdata('inv_userid');
		    //if ($id != $ids) {
		        //show_404();exit;
		        //redirect(base_url().'users/edit/'.$ids,'refresh');
		    //}
