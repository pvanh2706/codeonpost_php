 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Chi phí
        <small>Quản lý chi phí</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
        <li><a href="<?php echo $base_url; ?>expense">Thống kê chi phí</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info ">
            <div class="box-header with-border">
              <h3 class="box-title">Tiền, tiền, tiền cái quần què gì cũng tiền!</h3>
            </div>
            <!-- /.box-header -->
              ...
              <div class="box-body">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                      <label for="expense_date" class="col-sm-4 control-label">Ngày <label class="text-danger">*</label></label>
                  ...
                  <div class="form-group">
                  <label for="category_id" class="col-sm-4 control-label">Phân loại <label class="text-danger">*</label></label>
                  ...
                  <!--div class="form-group">
                      <label for="expense_for" class="col-sm-4 control-label">Thụ hưởng </label>

                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="expense_for" name="expense_for" placeholder="Cá nhân hoặc đơn vị thụ hưởng" onkeyup="shift_cursor(event,'expense_amt')" value="<?php print $expense_for; ?>" >
          <span id="expense_for_msg" style="display:none" class="text-danger"></span>
                  </div>
                  </div-->
                  <input type="hidden" name="expense_for"  id="expense_for" value="Không có">
                  <div class="form-group">
                  <label for="expense_amt" class="col-sm-4 control-label">Số tiền <label class="text-danger">*</label></label>
                  <div class="col-sm-8">
          ...
          <span id="expense_amt_msg" style="display:none" class="text-danger"></span>
               ...
               <div class="col-md-5">
                   ...
                   <div class="form-group">
                  <label for="reference_no" class="col-sm-4 control-label">Mã tham chiếu</label>
                  <div class="col-sm-8">
          ...
          <span id="reference_no_msg" style="display:none" class="text-danger"></span>
                   ...
                   <div class="form-group">
                  <label for="note" class="col-sm-4 control-label">Ghi chú thêm</label>
                  <div class="col-sm-8">
