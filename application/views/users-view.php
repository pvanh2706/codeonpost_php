...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Người dùng quản trị
        <small>Thêm sửa người dùng quản trị POS</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>users/add">
          ...
          $q1=$this->db->query($qs1);
            ...
            foreach ($q1->result() as $res1){
              ...
              <td> <?php echo $res1->role_name;?> </td>
                 ...
                 { echo "  <span  class='label label-default' disabled='disabled' style='cursor:disabled'>Toàn năng</span>"; }
								 else if($res1->status==1)                   //1=Active, 0=Inactive
								 { echo "  <span onclick='update_status(".$res1->id.",0)' id='span_".$res1->id."'  class='label label-success' style='cursor:pointer'>Kích hoạt </span>"; }
								 else
								 {
									 echo "<span onclick='update_status(".$res1->id.",1)' id='span_".$res1->id."'  class='label label-danger' style='cursor:pointer'> Vô hiệu hóa </span>";
								}
								 ?>
							</td>
              <td>
                    ...
                    <ul role="menu" class="dropdown-menu dropdown-light pull-right">
                      ...
                      <li>
                        <a title="Update Record ?" href="<?= $base_url; ?>users/edit/<?= $res1->id; ?>">
                          <i class="fa fa-fw fa-edit text-blue"></i>Sửa
                        </a>
                      </li>
