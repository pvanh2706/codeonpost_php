        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span id="role_id_fornv" data-roleid="<?php print ucfirst($this->session->userdata('role_id')); ?>" class="hidden-xs" ><?php print ucfirst($this->session->userdata('inv_username')); ?></span>
            </a>
