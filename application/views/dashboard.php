...
<div class="wrapper">
  ...
  <div class="content-wrapper ">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>Thông tin tổng quát</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                ...
                <div class="info-box-content">
                   <span class="text-bold text-uppercase">Doanh số</span>
                   <span class="info-box-number">Hôm nay | <span style="color: red;"><?= $CI->currency(app_number_format($total_day)); ?></span> <br>Tháng <?= $this_month ?> | <span style="color: blue;"><?= $CI->currency(app_number_format($total_month)); ?></span></span>
                </div>
                <!-- /.info-box-content -->
             </div>
             <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                ...
                <div class="info-box-content">
                    <span class="text-bold text-uppercase">Tổng công nợ </span>
                    <span class="info-box-number"><?= $CI->currency(app_number_format($sales_due)); ?> <i class="fa fa-arrow-circle-o-up" aria-hidden="true"></i> B</span>
                   <span class="info-box-number"><?= $CI->currency(app_number_format($purchase_due)); ?> <i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i> N</span>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                ...
                <div class="info-box-content">
                   <span class="text-bold text-uppercase">Tổng doanh số</span>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                ...
                <div class="info-box-content">
                   <span class="text-bold text-uppercase">Tổng chi phí vận hành</span>
      ...
      <div class="row">
        <div class="col-lg-4 col-xs-6">
            <a href="<?= base_url('customers') ?>" class="small-box-footer text-uppercase">
          <div class="small-box bg-dream-pink">
            <div class="inner text-uppercase">
              <h3><?= $tot_cust;?></h3><p>Khách hàng</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-4 col-xs-6"><a href="<?= base_url('purchase') ?>" class="small-box-footer text-uppercase">
          <div class="small-box bg-dream-maroon">
            <div class="inner text-uppercase">
              <h3><?= $tot_pur;?></h3><p>Hóa đơn nhập hàng</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-4 col-xs-6"><a href="<?= base_url('sales') ?>" class="small-box-footer text-uppercase">
          <div class="small-box bg-dream-green">
            <div class="inner text-uppercase">
              <h3><?= $tot_sal;?></h3><p>Hóa đơn bán hàng</p>
            </div>
            <div class="icon">
              <i class="ion ion-ios-paper-outline"></i>
            </div>
     ...
     <div class="col-md-8" style="display: flex;">
      <!-- BAR CHART -->
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title text-uppercase">Biểu đồ Nhập hàng / Bán hàng</h3>
        ...
        <div class="col-md-4" style="display: flex;">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title text-uppercase">Sản phẩm mới cập nhật</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
                ...
                <?php
                    $i=1;
                    $qs5="SELECT item_name,sales_price FROM db_items where status=1 ORDER BY id desc limit 4";
                    ...
                    if($q5->num_rows() >0){
                      ...
                      foreach($q5->result() as $res5){
                        ...
                        <tr>
                          ...
                          <td><?php echo $CI->currency(number_format($res5->sales_price),$with_comma=true); ?></td>
                        </tr>
      ...
      <!--div class="row">
          <div class="col-md-12">
              <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title text-uppercase">THỐNG KÊ DOANH SỐ CÁC NGÀY TRONG THÁNG</h3>
            </div>
          <figure class="highcharts-figure">
            ...
            <?php console_log(numberofmonth(date("m"), date("Y"))); ?>
            <script>
                ...
                xAxis: {
                    categories: <?= numberofmonth(date("m"), date("Y")) ?>,
                    crosshair: true,
                    accessibility: {
                        description: 'Ngày'
                    }
                ...
                series: [
                    {
                        name: 'Tháng <?= date("m",strtotime("-1 month")) ?>',
                        data: <?= loadDataSalesChart(date("m",strtotime("-1 month"))) ?>.map(i=>Number(i))
                    },
                    {
                        name: 'Tháng <?= date("m")?>',
                        data: <?= loadDataSalesChart(date("m")) ?>.map(i=>Number(i))
                    }
                ]
            });
  ...
  /* PIE CHART*/
         Highcharts.chart('bar_container', {
             ...
             series: [{
                 ...
                 <?php 
            //PIE CHART
            $q3=$this->db->query("SELECT COALESCE(SUM(b.sales_qty),0) AS sales_qty, a.item_name FROM db_items AS a, db_salesitems AS b ,db_sales AS c WHERE b.item_id <> -1 AND a.id=b.`item_id` AND b.sales_id=c.`id` AND c.`sales_status`='Final' GROUP BY a.id limit 10");
            if($q3->num_rows() >0){
