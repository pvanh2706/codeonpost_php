          ...
          <div class="box box-primary">
            ...
            <?php } ?>
              <div class="row">
                ...
                <div class="col-md-12 form-group">
                    <div class="input-group">
                        <span class="input-group-addon" title="Chính sách giá"><i class="fa fa-dollar"></i></span>
...
function addrow_gift(id='',item_obj=''){
        ...
        var str='<tr id="tr_items_name_'+rowcount+'"><td colspan="5" id="td_'+rowcount+'_0"><span id="td_data_'+rowcount+'_0" style="white-space: break-spaces; text-overflow: ellipsis; overflow: hidden;">'+ item_name     +'</span></td></tr>';
         str+='<tr class="itemrows" data-rowcount="'+rowcount+'" id="row_'+rowcount+'" data-price-lv="" data-row="0" data-item-id='+item_id+'>';/*item id*/
