                ...
                <div class="modal-dialog modal-sm">
                  <div class="modal-content">
                    <div class="modal-header header-custom">
                      ...
                      <h4 class="modal-title text-center">Thêm loại thuế</h4>
                    </div>
                          ...
                          <div class="col-md-12">
                            <div class="box-body">
                              <div class="form-group">
                                <label for="tax_name">Tên loại thuế*</label>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-primary add_tax">Lưu</button>
                    </div>
                  </div>
                  <!-- /.modal-content -->
                </div>
