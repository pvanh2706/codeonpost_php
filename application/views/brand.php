 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>Quản lý các thương hiệu hợp tác</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
        <li><a href="<?php echo $base_url; ?>brand/view">Danh sách thương hiệu</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info ">
            <div class="box-header with-border">
              <h3 class="box-title">Cung cấp thông tin thương hiệu</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			...
			<div class="form-group">
			      <label for="brand" class="col-sm-2 control-label">Tên thương hiệu<label class="text-danger">*</label></label>
           <div class="col-sm-4">
             <input type="text" class="form-control input-sm" id="brand" name="brand" placeholder="" onkeyup="shift_cursor(event,'description')" value="<?php print $brand_name; ?>" autofocus >
				...
				<div class="form-group">
                  <label for="description" class="col-sm-2 control-label">Ghi chú thêm</label>
                  <div class="col-sm-4">
