    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="" class="navbar-brand" title="<?php  echo $SITE_TITLE;?>"><b class="hidden-xs"><?php  echo $SITE_TITLE;?></b><b class="hidden-lg">POS</b></a>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Điều chỉnh chiết khấu</h4>
                    </div>
                          ...
                          <div class="col-md-6">
                            <div class="box-body">
                              <div class="form-group">
                                <label for="discount_input">Giá trị chiết khấu</label>
                            ...
                            <div class="box-body">
                              <div class="form-group">
                                ...
                                <select class="form-control" id='discount_type' name="discount_type">
                                  <option value='in_percentage'>Theo %</option>
            ...
            <?php } ?>
              ...
              <div class="row">
                    <div class="col-xs-12 ">
                      <!--div class="col-md-6">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                              <label for="other_charges" class="col-sm-7 control-label">Phụ phí khác <label class="text-danger">*</label></label>
              ...
              <div class="box-footer bg-gray">
                ...
                <div class="row">
                  ...
                  <?php if(isset($sales_id)){ $btn_id='update';$btn_name="Cập nhật đơn"; ?>
                    <input type="hidden" name="sales_id" id="sales_id" value="<?php echo $sales_id;?>"/>
                  <?php } else{ $btn_id='save';$btn_name="Chốt đơn";} ?>

                  <div class="col-md-12 text-right">

                    <div class="col-sm-3">
                      <button type="button" id="hold_invoice" name="" class="btn bg-maroon btn-block btn-flat btn-lg" title="Giữ đơn [Ctrl+Shift+H]">
                      <i class="fa fa-hand-paper-o" aria-hidden="true"></i>
                       Giữ đơn
                    </button>
                    </div>
                    <div class="col-sm-3">
                      <button type="button" id="" name="" class="btn btn-primary btn-block btn-flat btn-lg" title="In tạm tính [Ctrl+Shift+M]" onClick="alert('Chưa làm');">
                            <i class="fa fa-credit-card" aria-hidden="true"></i>
                             In tạm tính
                          </button>
                    </div>
                    <div class="col-sm-6">
                      <button type="button" id="<?php echo "show_cash_modal";?>" name="" class="btn btn-success btn-block btn-flat btn-lg shift_c" title="Thanh toán [Ctrl+Shift+C]">
                  ...
                  <!-- <div class="form-group"> -->
                   <!--  <div class="col-sm-12"> -->
                      <!-- <style type="text/css">
                            ...
                            <section class="content" >
                              <div class="row search_div" style="overflow-y: scroll;min-height: 100px;height: 70vh;">
                              </div>
                            </section>
...
<script src="<?php echo $theme_link; ?>js/fullscreen.js?v=<?= time()?>"></script>
...
<link href="<?php echo $theme_link; ?>css/jquery.ml-keyboard.css" rel="stylesheet" type="text/css">
<script src="<?php echo $theme_link; ?>js/jquery.ml-keyboard.js"></script>  
...
function addrow(id='',item_obj=''){
    ...
    var str=' <tr id="row_'+rowcount+'" data-row="0" data-item-id='+item_id+'>';/*item id*/
        str+='<td id="td_'+rowcount+'_0"><!--i onclick="show_sales_item_modal('+rowcount+')" class="fa fa-edit pointer"></i--> <a data-toggle="tooltip" title="Click to Change Tax" class="pointer" id="td_data_'+rowcount+'_0" onclick="show_sales_item_modal('+rowcount+')">'+ item_name     +'</a> </td>';/* td_0_0 item name*/ 
        str+='<td class="<?=tax_disable_class()?>" id="td_'+rowcount+'_1">'+ stock +'</td>';/* td_0_1 item available qty*/
        ...
        str+='<td id="td_'+rowcount+'_6" class="text-right <?=tax_disable_class()?>">'+ info   +'</td>';
...
<script>
           /* var util = { };
            document.addEventListener('keydown', function(e){
                ...
                alert("Hello! Bạn không được bấm phím " + key + " này!!");
                //switch (key) {
                    ...
                    //case 'Esc': alert("Hello! Bạn không được bấm nút Esc này!!"); break;
                //}
            })
    ...
    <script>
        $(document).ready(function(){
            //$('#item_search').mlKeyboard();
            //$('#item_name').mlKeyboard();
            //$('.form-control').mlKeyboard();
