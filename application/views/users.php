      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <h1>
                  <?= $page_title; ?>
                  <small><?= $this->session->userdata('inv_username'); ?></small>
               </h1>
               <ol class="breadcrumb">
                  <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
                  <li><a href="<?php echo $base_url; ?>users/view">Xem chi tiết</a></li>
                  <li class="active"><?= $this->session->userdata('inv_username'); ?></li>
               </ol>
            </section>
            <!-- Main content -->
                        ...
                        <!-- form start -->
                           ...
                           <div class="box-body">
                              ...
                              <div class="col-md-6">
                                 ...
                                 <label for="" class="col-sm-4 control-label">Hạn sử dụng </label>
                                 <div class="col-sm-8">
                                    <input type="text" readonly class="form-control input-sm" id="" name="" placeholder="" onkeyup="" value="<?php print '[' . $this->session->userdata('validate') . '] ' . date("d-m-Y H:i:s",$validate) ; ?>"  autofocus>
                                 </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                 <label for="mobile" class="col-sm-4 control-label">Số điện thoại <label class="text-danger">*</label></label>
                                 <div class="col-sm-8">
                              ...
                              <div class="form-group">
                                 <label for="email" class="col-sm-4 control-label">Email đăng ký <label class="text-danger">*</label></label>
                                 <div class="col-sm-8">
                              ...
                              <div class="form-group">
                                 <label for="role_id" class="col-sm-4 control-label">Quyền tài khoản <label class="text-danger">*</label> </label>
                                 <div class="col-sm-8">
                              ...
                              <div class="form-group">
                                 <label for="pass" class="col-sm-4 control-label">Mật khẩu đăng nhập
                                 <?php if(empty($q_id)){ ?>
                                 <label class="text-danger">*</label>
                                 <?php }?>
                              </label>
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm"  <?php print $disabled; ?> id="pass" name="pass" placeholder="Bỏ trống nếu không thay đổi" onkeyup="shift_cursor(event,'confirm')"  >
                                    <span id="pass_msg" style="display:none" class="text-danger"></span>
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label for="confirm" class="col-sm-4 control-label">Xác nhận mật khẩu
                                 <?php if(empty($q_id)){ ?>
                                 <label class="text-danger">*</label>
                                 <?php }?>
                              </label>
                                 <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm" <?php print $disabled; ?> id="confirm" name="confirm" placeholder="Bỏ trống nếu không thay đổi">
                              ...
                              <div class="col-md-6">
                                  <div class="form-group">
                                     <label for="address" class="col-sm-4 control-label">Ảnh đại diện</label>
                                     <div class="col-sm-8">
