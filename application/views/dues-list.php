...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>Thống kê tất cả các công nợ</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                       <label for="user_created_by">Hóa đơn tạo bởi </label></label>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
               ...
               <tfoot>
                  <tr class="bg-gray">
                      <th colspan="6" style="text-align:right">#</th><!-- 6 -->
                      <th></th><!-- 7 -->
                      <th></th><!-- 8 -->
                      <th></th><!-- 8 -->
                      <th></th><!-- 7 -->
...
<script type="text/javascript">
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('duelist/ajax_list')?>",
            "type": "POST",
            "data": {
