  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header header-custom">
        ...
        <h4 class="modal-title text-center">Thanh toán hóa đơn</h4>
      </div>
    ...
    <div class="row">
                ...
                <div class="box box-solid bg-gray">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="">
                                    <label for="amount_<?= $i;?>">Tổng tiền nhận</label>
              ...
              <div class="box-body">
                <div class="row ">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">Số lượng sản phẩm:</span>
                ...
                <div class="row ">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">Tổng tạm tính:</span>
                ...
                <div class="row bg-red">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">Tổng thanh toán:</span>
                ...
                <div class="row ">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">Thanh toán:</span>
                ...
                <div class="row ">
                  <div class="col-md-12 border-custom-bottom">
                    <span class="col-md-6 text-right text-bold ">Công nợ:</span>
                ...
                <div class="row ">
                  <div class="col-md-12 bg-orange">
                    <span class="col-md-6 text-right text-bold ">Tiền thừa trả lại:</span>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn bg-maroon btn-lg make_sale btn-lg" onclick="save()"><i class="fa  fa-save "></i> Lưu</button>
        <button type="button" class="btn btn-success btn-lg make_sale btn-lg" onclick="save(true)"><i class="fa  fa-print "></i> Lưu & In hóa đơn</button>
