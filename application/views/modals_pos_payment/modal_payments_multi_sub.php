...
<div class="col-md-12 payments_div payments_div_<?=$rowcount?>">
          <div class="box box-solid bg-gray">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="">
                  <label for="amount_<?= $rowcount;?>">Tổng tiền nhận</label>
                ...
                <div class="col-md-12">
                  <div class="">
                    <label for="payment_type_<?= $rowcount;?>">Hình thức thanh toán</label>
        ...
        <div class="row">
               <div class="col-md-12">
                  <div class="">
                    <label for="payment_note_<?= $rowcount;?>">Ghi chú thêm cho hóa đơn</label>
