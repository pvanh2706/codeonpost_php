 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?= $page_title; ?>
        <small>Điều chỉnh <?= $page_title; ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
        <li><a href="<?php echo $base_url; ?>expense/category">Danh sách</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info ">
            <div class="box-header with-border">
              <h3 class="box-title">Đậu mé 3 đầu 6 tay 2 con cu</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			...
			<div class="form-group">
			      <label for="category" class="col-sm-2 control-label">Tên danh mục chi phí<label class="text-danger">*</label></label>
           <div class="col-sm-4">
             <input type="text" class="form-control input-sm" id="category" name="category" placeholder="" onkeyup="shift_cursor(event,'description')" value="<?php print $category_name; ?>" autofocus >
				...
				<div class="form-group">
                  <label for="description" class="col-sm-2 control-label">Ghi chú cho dễ phân biệt</label>
                  <div class="col-sm-4">
