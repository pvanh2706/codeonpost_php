      ...
      <!--div class="btn-group hidden-xs">
            ...
            <ul class="dropdown-menu" >
                <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>points" ><h4><i class="fa fa-plus text-green"></i> Lịch sử</h4></a>
                  </li>
                <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>sales/stock" ><h4><i class="fa fa-plus text-green"></i> Kiểm hàng</h4></a>
                  </li>
                <?php if($CI->permissions('expense_add')) { ?>
                  <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>expense/add" ><h4><i class="fa fa-plus text-green"></i> Chi phí</h4></a>
                  </li>  
                  <?php } ?>
                  <?php if($CI->permissions('items_add')) { ?>
                  <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>items/add" ><h4><i class="fa fa-plus text-green"></i> Sản phẩm</h4></a>
                  </li> 
                  <?php } ?>
                  <?php if($CI->permissions('sales_add')) { ?>
                  <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>sales/add" ><h4><i class="fa fa-plus text-green"></i> Bán hàng</h4></a>
                  </li> 
                  <?php } ?>
                  <?php if($CI->permissions('purchase_add')) { ?>
                  <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>purchase/add" ><h4><i class="fa fa-plus text-green"></i> Nhập hàng</h4></a>
                  </li> 
                  <?php } ?>
                  <?php if($CI->permissions('customers_add')) { ?>
                  <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>customers/add" ><h4><i class="fa fa-plus text-green"></i> Khách hàng</h4></a>
                  </li> 
                  <?php } ?>
                  <?php if($CI->permissions('suppliers_add')) { ?>
                  <li class="border_bottom">
                    <a href="<?php echo $base_url; ?>suppliers/add" ><h4><i class="fa fa-plus text-green"></i> Nhà cung cấp</h4></a>
                  </li>
                  <?php } ?>
      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="nav navbar-nav">
          ...
          <!--li class="text-center" id="">
            <a title="POS [Shift+P]" href="<?php echo $base_url; ?>pos" target="_Blank"><i class="fa fa-plus-square " ></i><Span>&nbsp;&nbsp;&nbsp;Aqua POS</Span></a>   
          </li-->
          <?php } ?>

          <!--li class="text-center hidden-xs" id="">
            <a title="Dashboard" href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard " ></i> Trang chủ</a>
          </li-->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="dashboard-active-li "><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard text-aqua"></i> <span>Tóm lượt</span></a></li>
		<?php } ?>
		
		<?php if($CI->permissions('pos')) { ?>
            <!--li class="pos-active-li"><a target="_Blank" href="<?php echo $base_url; ?>pos"><i class="fa fa-calculator text-aqua"></i> <span>POS bán hàng</span></a></li-->
        <?php } ?>
		...
		<?php if($CI->permissions('sales_add')  || $CI->permissions('pos')  || $CI->permissions('sales_view')) { ?>
    ...
    <?php if($CI->permissions('import_items') || $CI->permissions('items_add') || $CI->permissions('items_view') || $CI->permissions('print_labels') || $CI->permissions('items_stock')) { ?>
    ...
    <?php if ($this->session->userdata('inv_userid') == '1') { ?>
     ...
     <li class="sms-active-li sms-api-active-li sms-template-active-li sms-templates-list-active-li treeview">
          <a href="#">
            <i class="fa fa-envelope text-aqua"></i> <span><?= $this->lang->line('sms'); ?> <?= $this->session->userdata('inv_userid'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
    ...
    <?php if($change_password=true && $CI->permissions('dashboard')) { ?>
		<li class=" company-profile-active-li site-settings-active-li  change-pass-active-li dbbackup-active-li warehouse-active-li warehouse-list-active-li tax-active-li currency-view-active-li currency-active-li  database_updater-active-li tax-list-active-li units-list-active-li unit-active-li payment_types_list-active-li payment_types-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="tax-active-li  tax-list-active-li"><a href="<?php echo $base_url; ?>tax"><i class="fa fa-percent  "></i> <span>Danh sách thuế</span></a></li>
            <?php } ?>
            ...
            <li class="payment_types_list-active-li payment_types-active-li"><a href="<?php echo $base_url; ?>payment_types/"><i class="fa fa-list "></i> <span>Kiểu thanh toán</span></a></li>
            <?php } ?>

            <?php if($CI->permissions('currency_view') && $this->session->userdata('inv_userid') == '1') { ?>
            <li class="currency-view-active-li currency-active-li"><a href="<?php echo $base_url; ?>currency/view"><i class="fa fa-gg "></i> <span>Loại tiền tệ</span></a></li>
            <?php } ?>
        ...
        <?php if($CI->permissions('pos')) { ?>
            <li class="" style="background-color: green; font-weight: bold;" onclick="OpenPos('<?php echo $base_url; ?>pos');"><a ><i class="fa fa-calculator text-aqua"></i> <span>Máy POS bán hàng</span></a></li>
        <?php } ?>
        ...
        <hr>
        <!--li class="" style="background-color: red; font-weight: bold;"><a href="<?php echo $base_url; ?>extend_use" style="color: yellow;"><i class="fa fa-clock-o text-aqua"></i> <span>Gia hạn sử dụng POS</span></a></li-->
