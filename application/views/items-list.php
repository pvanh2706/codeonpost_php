...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>Quản lý thông tin sản phẩm</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box">
            <div class="box-header with-border">
              <div class="row">
                    <div class="col-md-12">
                    <div class="col-md-3">
                        <label for="brand_id" class=" control-label">Nhãn hàng</label>
                    ...
                    <!--div class="col-md-3">
                        <label for="items_name_s" class=" control-label">Tên sản phẩm</label>
                          <div class="input-group">
                                                <span class="input-group-addon" title="Select Items"><i class="fa fa-barcode"></i></span>
                                                 <input type="text" class="form-control " placeholder="Item name/Barcode/Itemcode" id="items_name_s">
                                              </div>
                    </div-->
...
$("#brand_id,#category_id,#items_name_s").on("change",function(){
