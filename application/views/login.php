...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Vui lòng đăng nhập tài khoản quản trị</p>
    ...
    <form action="<?php echo $base_url; ?>login/verify" method="post" id="login">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Tên đăng nhập" id="username" name="username" autofocus><span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <p style='font-style: italic;'>D4Teams - AquaHome POS - v 1.0.0 <?//=app_version();?></p>   
      </div>
    </div>
