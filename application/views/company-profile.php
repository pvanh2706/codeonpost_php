      ...
      <div class="row">
        ...
        <div class="col-md-12">
              ...
              <div class="box-body">
                ...
                <div class="col-md-5">
                  ...
                  <div class="form-group">
                      <label for="company_name" class="col-sm-4 control-label">Tên doanh nghiệp<label class="text-danger">*</label></label>
          ...
          <span id="company_name_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                      <label for="mobile" class="col-sm-4 control-label">Điện thoại<label class="text-danger">*</label></label>
          ...
          <span id="mobile_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                  <label for="email" class="col-sm-4 control-label">Email liên hệ<label class="text-danger">*</label></label>
                  <div class="col-sm-8">
          ...
          <span id="upi_id_msg" style="display:none" class="text-danger"></span>
                  ...
                  <!--div class="form-group">
                  <label for="bank_details" class="col-sm-4 control-label">Thông tin chuyển khoản</label>
                  <div class="col-sm-8">
          ...
          <span id="bank_details_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                  <label for="company_logo" class="col-sm-4 control-label">Logo doanh nghiệp</label>
                  <div class="col-sm-8">
                      <input type="file" id="company_logo" name="company_logo">
                      <span id="company_logo_msg" style="display:block;" class="text-danger">Kích thước tối đa: 1000px * 1000px & Kích cỡ tối đa: 1024kb </span>
                   </div>
                  </div>
          ...
          <span id="state_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                  <label for="city" class="col-sm-4 control-label">Khu vực<label class="text-danger">*</label></label>
                  <div class="col-sm-8">
          ...
          <span id="postcode_msg" style="display:none" class="text-danger"></span>
                   ...
                   <div class="form-group">
                  <label for="address" class="col-sm-4 control-label">Địa chỉ<label class="text-danger">*</label></label>
                  <div class="col-sm-8">
