   ...
   <body class="hold-transition skin-blue  sidebar-mini">
    ...
    <!-- **********************MODALS END***************** -->
      ...
      <?php
         ...
         $sku='SKU-'.str_pad($maxid, 4, '0', STR_PAD_LEFT).'-'.substr($codecreate, 0, 5);
         $hsn='HSN-'.str_pad($maxid, 4, '0', STR_PAD_LEFT).'-'.substr($codecreate, -5);
         $custom_barcode=$codecreate.str_pad($maxid, 4, '0', STR_PAD_LEFT);
         //end
                        ...
                        <div class="box-body">
                           <div class="row">
                              <div class="form-group col-md-3">
                                 <label for="item_code">Mã sản phẩm<span class="text-danger">*</span></label>
                                 <input type="text" class="form-control" id="item_code" name="item_code" placeholder="" value="<?php print $item_code; ?>" readonly>
                           ...
                           <div class="row">
                              <div class="form-group col-md-4">
                                 <label for="item_name">Tên sản phẩm<span class="text-danger">*</span></label>
                              ...
                              <div class="form-group col-md-4">
                                 <label for="alert_qty" >Số lượng cảnh báo tồn kho</label>
                              ...
                              <div class="form-group col-md-4">
                                 <label for="custom_barcode" >Ghi chú</label>
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <span id="item_image_msg" style="display:block;" class="text-danger">Kích thước ảnh tối đa: 1000px * 1000px & Kích cỡ tối đa: 1MB </span>
                              </div>
                           </div>
                           <hr>
                           <div class="row">
                                <div class="form-group col-md-4">
                                 <label for="price">Giá tham chiếu đầu vào<span class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-md-4 ">
                                 <label for="tax_id" >Thuế<span class="text-danger">*</span></label>
                                 <div class="input-group">
                              ...
                              <div class="form-group col-md-4">
                                 <label for="profit_margin">Ước tính lợi nhuận (%) <i class="hover-q " data-container="body" data-toggle="popover" data-placement="top" data-content="<?= $this->lang->line('based_on_purchase_price'); ?>" data-html="true" data-trigger="hover" data-original-title="">
                                  <i class="fa fa-info-circle text-maroon text-black hover-q"></i>
                                </i></label>
                                 <input type="text" class="form-control only_currency" id="profit_margin" name="profit_margin" placeholder="Ước tính lợi nhuận theo tỷ lệ %"  value="<?php print $profit_margin; ?>" >
                           ...
                           <div class="row">
                               <div class="form-group col-md-4">
                                 <label for="purchase_price">Giá nhập hàng<span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency" id="purchase_price" name="purchase_price" placeholder="Giá nhập hàng = Giá tham chiếu đầu vào"  value="<?php print $purchase_price; ?>" readonly='' >
                              ...
                              <div class="form-group col-md-4 <?=tax_disable_class()?>">
                                 ...
                                 <select class="form-control select2" id="tax_type" name="tax_type"  style="width: 100%;" >
                                  ...
                                  ?>
                                    <option <?= $exclusive_selected ?> value="Exclusive">Loại trừ thuế</option>
                                    <option <?= $inclusive_selected ?> value="Inclusive">Bao gồm thuế</option>
                                 </select>
                              ...
                              <div class="form-group col-md-4">
                                 <label for="sales_price" class="control-label">Giá bán lẻ đề xuất<span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency " id="sales_price" name="sales_price" placeholder="Thay đổi hay không tùy bạn!"  value="<?php print $sales_price; ?>" >
                                 <span id="sales_price_msg" style="display:none" class="text-danger"></span>
                              </div>
                           </div>
                           <div class="row">
                              <div class="form-group col-md-4">
                                 <label for="final_price" class="control-label">Giá bán lẻ<span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency " id="final_price" name="final_price" placeholder=""  value="<?php print $final_price; ?>" readonly >
                                 <span id="final_price_msg" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-2">
                                 <label for="final_price0" class="control-label">Giá đại lý cấp 0<span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency " id="final_price0" name="final_price0" placeholder=""  value="<?php print $final_price0; ?>"  >
                                 <span id="final_price_msg0" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-2">
                                 <label for="final_price1" class="control-label">Giá đại lý cấp 1<span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency " id="final_price1" name="final_price1" placeholder=""  value="<?php print $final_price1; ?>"  >
                                 <span id="final_price_msg1" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-2">
                                 <label for="final_price2" class="control-label">Giá đại lý cấp 2<span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency " id="final_price2" name="final_price2" placeholder=""  value="<?php print $final_price2; ?>"  >
                                 <span id="final_price_msg2" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-2">
                                 <label for="final_price3" class="control-label">Giá đại lý cấp 3<span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency " id="final_price3" name="final_price3" placeholder=""  value="<?php print $final_price3; ?>"  >
                                 <span id="final_price_msg3" style="display:none" class="text-danger"></span>
                              </div>
                           </div>
                           <!-- /row -->
                           <hr>
                           ...
                           <div class="row">
                              <div class="form-group col-md-4">
                                 <label for="current_opening_stock">Số lượng trong kho hiện tại</label>
                              ...
                              <div class="form-group col-md-4">
                                 <label for="new_opening_stock">Điều chỉnh số lượng trong kho <i class="hover-q " data-container="body" data-toggle="popover" data-placement="top" data-content="<?= $this->lang->line('stock_adjustment_msg'); ?>" data-html="true" data-trigger="hover" data-original-title="">
                                  <i class="fa fa-info-circle text-maroon text-black hover-q"></i>
                                </i></label>
                              ...
                              <div class="form-group col-md-4">
                                 <label for="adjustment_note" >Nội dung điều chỉnh</label>
                                 <input type="text" class="form-control" id="adjustment_note" name="adjustment_note" placeholder="" value="<?php print $adjustment_note; ?>" >
               ...
               <div class="col-md-12">
                    ...
                    <div class="box">
                      <div class="box-header">
                        <h3 class="box-title text-blue">Lịch sử điều chỉnh số lượng sản phẩm này trong kho hàng</h3>
                      </div>
                      <!-- /.box-header -->
                              ...
                              <?php 
                                if(isset($q_id)){
                                  ...
                                  if($q3->num_rows()>0){
                                    ...
                                    echo "<tr><td colspan='5' class='text-center text-bold'>Chưa có dữ liệu điều chỉnh!</td></tr>";
                                  }
                                }
                                else{
                                  echo "<tr><td colspan='5' class='text-center text-bold'>Chưa có dữ liệu điều chỉnh!!</td></tr>";
      ...
      <script src="<?php echo $theme_link; ?>js/items.js?v=<?= time() ?>"></script>
