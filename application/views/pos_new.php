      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class=""><a href="<?php echo $base_url; ?>items/" title="View Items List"><i class="fa  fa-cubes text-yellow " ></i> <span>Thống kê sản phẩm</span></a></li>
            <?php } ?>
            
            <?php if($CI->permissions('sales_view')) { ?>
            <li class=""><a href="<?php echo $base_url; ?>sales" title="View Sales List!"><i class="fa fa-list text-yellow" ></i> <span>Thống kê đơn hàng</span></a></li>
            <?php } ?>
            
            
            
            <?php if($CI->permissions('sales_add')) { ?>
            <li class=""><a href="<?php echo $base_url; ?>pos" title="Create New POS Invoice"><i class="fa fa-calculator text-yellow " ></i> <span>Đơn hàng mới</span></a></li>
            <?php } ?>
          </ul>
        </div>
        <!-- /.navbar-collapse -->
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Click To View Hold Invoices">
              <span class=""><i class="fa fa-hand-paper-o" aria-hidden="true"></i></span>
            ...
            <li class="text-center" id=""><a title="Dashboard" href="<?php echo $base_url; ?>dashboard"><i class="fa fa-money" ></i></a></li>
                        ...
                        <span class="input-group-addon" title="Customer"><i class="fa fa-user"></i></span>
                         ...
                         <script>
                             /*$("#customer_id").change(function(){
                                ...
                                $.ajax({
                                    type: "GET",
                                    url: "https://pos.sieuthithuysinh.com/customers/getCustomers/"+value,
                                    dataType: "json"
                                   ...
                                   //$("#customerPoint").text(" [" + result[0].point + "]");
                                   //$("#customerLevel").attr('data-level', result[0].level);
                                   $("#hidden_cusLevel").val(result[0].level);
                                   $("#customerLVP").val("[" + text + "] | " + level + " | [" + result[0].point.replace(/\B(?=(\d{3})+(?!\d))/g, ',') + " điểm]");
                                   $("#customerLVP").attr('data-lv', result[0].level);
                                   $("#customerLVP").attr('data-po', result[0].point);
                ...
                <div class="row">
                    <div class="col-xs-12 ">
                      <!--div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="other_charges" class="col-sm-7 control-label">Thêm phụ phí khác <label class="text-danger">*</label></label>

                                <div class="col-sm-5">
                                    <input type="text" class="form-control text-right" id="other_charges" name="other_charges" placeholder="0.00"  value="<?=$other_charges?>" onkeyup="calculate_payments()">
               ...
               <br>
                <div class="row">
                  ...
                  <div class="col-md-12 text-right">
                    ...
                    <div class="col-sm-6">
                        <button type="button" class="btn bg-maroon btn-lg make_sale btn-lg btn-block" onclick="save()"><i class="fa  fa-save "></i> Lưu</button>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="input-group" id="" >
                            ...
                            <script>
                                ...
                                $("#customerLVP").val("Đang chọn chính sách giá của " + level);
                    ...
                    <div class="col-md-7">
                        <div class="input-group" id="" >
                            ...
                            <input style="color: red;" class="form-control text-bold" type="text" readonly id="customerLVP" name="customerLVP" value="Đang chọn chính sách giá của Khách lẻ" />
                        </div>
                    </div>
                </div>
                <br>
                   ...
                   <!--  <div class="col-sm-12"> -->
                      <!-- <style type="text/css">
                            ...
                            <section class="content" id="loadItems">
                              <div class="row search_div" style="overflow-y: scroll;min-height: 500px;height: 100%;">
...
function addrow(id='',item_obj=''){
        ...
        var str='<tr  class="itemrows" data-rowcount="'+rowcount+'" id="row_'+rowcount+'" data-price-lv="" data-row="0" data-item-id='+item_id+'>';/*item id*/
