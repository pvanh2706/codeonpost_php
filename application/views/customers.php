 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      <?=$page_title;?>
        <small>Thêm / sửa thông tin khách hàng</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
              ...
              <div class="box-body">
                ...
                <div class="col-md-5">
                  <div class="form-group">
                      <label for="customer_name" class="col-sm-4 control-label">Tên khách hàng<label class="text-danger">*</label></label>
          ...
          <span id="customer_name_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                      <label for="customer_point" class="col-sm-4 control-label">Tích điểm</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control no_special_char_no_space" id="customer_point" name="customer_point" placeholder="" value="<?php print $customer_point; ?>"  >
                        <span id="customer_point_msg" style="display:none" class="text-danger"></span>
                      </div>
                  </div>

                
                  <div class="form-group">
                      <label for="mobile" class="col-sm-4 control-label">Số điện thoại</label>
          ...
          <span id="opening_balance_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                  <label for="customer_level" class="col-sm-4 control-label">Nhóm</label>

                    <div class="col-sm-8">
                        <select class="form-control select2" id="customer_level" name="customer_level"  style="width: 100%;"  >
                                <?php
                                ...
                                if($q1->num_rows($q1)>0)
                                 {
                                   ...
                                   {
                                    $selected = ($customer_level==$res1->id)? 'selected' : '';
                                     echo "<option $selected value='".$res1->id."'>".$res1->customer_level_name."</option>";
                                   }
                                 }
                                 else
                                 {
                    ...
                    <span id="customer_level_msg" style="display:none" class="text-danger"></span>
                  </div>
                  </div>
                  
                  <input type="hidden" name="country" value="1">
                  <input type="hidden" name="state" value="58">
                  <!--div class="form-group">
          ...
          <span id="postcode_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="col-sm-8">
                    <textarea rows="6" type="text" class="form-control" id="address" name="address" placeholder="" ><?php print $address; ?></textarea>
