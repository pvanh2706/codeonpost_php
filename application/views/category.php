 ...
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>Quản lý danh mục sản phẩm</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
        <li><a href="<?php echo $base_url; ?>category/view">Liệt kê danh mục</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info ">
            <div class="box-header with-border">
              <h3 class="box-title">Cung cấp thông tin danh mục</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			...
			<div class="form-group">
			      <label for="category" class="col-sm-2 control-label">Tên danh mục<label class="text-danger">*</label></label>
           <div class="col-sm-4">
