 ...
 <?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
         <h1>
            <?=$page_title;?>
            <small>Quản lý nhập hàng</small>
         </h1>
         <ol class="breadcrumb">
            <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
            <li><a href="<?php echo $base_url; ?>purchase">Danh sách nhập hàng</a></li>
                        ...
                        <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'purchase-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                           ...
                           <div class="box-body">
                              <div class="form-group">
                                 <label for="supplier_id" class="col-sm-2 control-label">Nhà cung cấp<label class="text-danger">*</label></label>
                                 <div class="col-sm-3">
                                    <div class="input-group">
                                       <select class="form-control select2" id="supplier_id" name="supplier_id"  style="width: 100%;">
                                       </select>
                                       <span class="input-group-addon pointer" data-toggle="modal" data-target="#supplier-modal" title="Thêm NCC mới?"><i class="fa fa-user-plus text-primary fa-lg"></i></span>
                                    </div>
                                    <span id="supplier_id_msg" style="display:none" class="text-danger"></span>
                                 </div>
                                 <label for="pur_date" class="col-sm-2 control-label">Thời gian nhập hàng <label class="text-danger">*</label></label>
                                 <div class="col-sm-3">
                              ...
                              <div class="form-group">
                                 <label for="purchase_status" class="col-sm-2 control-label">Tình trạng <label class="text-danger">*</label></label>
                                 <div class="col-sm-3">
                                       <select class="form-control select2" id="purchase_status" name="purchase_status"  style="width: 100%;" onkeyup="shift_cursor(event,'mobile')">
                                          ...
                                          ?>
              							                <option <?= $received_select; ?> value="Received">Hoàn thành</option>
              							                <option <?= $pending_select; ?> value="Pending">Chờ xử lý</option>
              							                <option <?= $ordered_select; ?> value="Ordered">Đã đặt hàng</option>
                                       </select>
                           ...
                           <div class="row">
                                  ...
                                  <div class="box">
                                    <div class="box-info">
                                      <div class="box-header">
                                        <div class="col-md-6 col-md-offset-2 d-flex justify-content" >
                                          <div class="input-group">
                                        ...
                                        <?php
                                            ...
                                            ?>
                                        <div class="col-md-4">
                                            <span class="form-control btn btn-success bg-maroon payments_modal" id="<?php echo $btn_id;?>"><?php echo $btn_name;?></span>
                                        </div>
                                      </div>
                                      <div class="box-body">
                                        ...
                                        <table class="table table-hover table-bordered" style="width:100%" id="purchase_table">
                                             <thead class="custom_thead">
                                                <tr class="bg-primary" >
                                                   ...
                                                   <th rowspan='2' style="width:7.5%">Đơn giá (<?=$CURRENCY;?>)</th>
                                                   <th rowspan='2' style="width:7.5%">Tổng tạm tính (<?=$CURRENCY;?>)</th>
                              ...
                              <div class="col-md-6">
                                <!--div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="" class="col-sm-4 control-label">Tổng số lượng sản phẩm</label>    
                                          <div class="col-sm-4">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div class="col-sm-4">
                                             <select class="form-control" onchange="final_total();" id='discount_to_all_type' name="discount_to_all_type">
                                                ...
                                                <option value='in_fixed'>Cố định (<?=$CURRENCY;?>) </option>
                                             </select>
                                          </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="purchase_note" class="col-sm-4 control-label">Ghi chú nhập hàng</label>    
                                          <div class="col-sm-8">
                                ...
                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                   <h4>
                                    <b id="discount_to_all_amt" name="discount_to_all_amt">0</b>₫</h4>
                                             ...
                                             <tr>
                                                <th class="text-right" style="font-size: 17px;">Tổng thanh toán nhập hàng</th>
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4>
                                                    <b id="total_amt" name="total_amt">0</b>₫</h4>
                                                </th>
                                             </tr>
                                          </table>
                                       </div>
                              ...
                              <div class="col-xs-12 ">
                                 <div class="col-sm-12">
                                       <div class="box-body ">
                                        ...
                                        <div class="col-md-6 payments_div payments_div_">
                                          ...
                                          <div class="box box-solid bg-gray">
                                            <div class="box-body">
                                              <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                  <div class="">
                                                  <label for="amount">Số tiền nhập hàng</label>
...
<!-- ./wrapper -->
<script src="<?php echo $theme_link; ?>js/purchase.js?v=<?= time() ?>"></script>  

<script src="<?php echo $theme_link; ?>js/ajaxselect/supplier_select_ajax.js?v=<?= time() ?>"></script>  
...
<script>
         ...
         /* ---------- CALCULATE GST END -------------*/
            function check_var_price(i){
                var item_name = $("#td_data_"+i+"_1").html();
                var item_ids = $("#tr_item_id_"+i).val();
                var item_checkprice = $("#td_data_"+i+"_4").val();
                $.post(base_url+"purchase/return_purchase_var_price/"+item_ids+"/"+item_checkprice,{},function(result){
                  //alert(item_name +' | Giá cũ: '+ result + ' | Giá mới: '+ item_checkprice);
                  //console.log(result);
                  //return result;
                  if (result != item_checkprice){
                      if (confirm(item_name + " có giá nhập thay đổi, giá nhập cũ: " + Intl.NumberFormat().format(result) + " Bạn có muốn lưu giá nhập mới " + Intl.NumberFormat().format(item_checkprice) + " cho sản phẩm này?") == true) {
                        //alert("ok con dê");
                        save_new_purchase_price(item_ids,item_checkprice);
                        alert("Đã cập nhật giá nhập mới cho sản phẩm " + item_name + " | Giá nhập mới: " + Intl.NumberFormat().format(item_checkprice));
                        /*if( save_new_purchase_price(item_ids,item_checkprice) == '1') {
                            alert("Đã cập nhật giá nhập mới cho sản phẩm " + item_name + " | Giá nhập mới: " + item_checkprice);
                        } else {
                            alert("Lỗi mạng rồi, thử lại sau đi bạn ơi!" );
                        }*/
                      } else {
                        alert("Ok tùy bạn vẫn giữ giá nhập cũ " + Intl.NumberFormat().format(result) + " ở sản phẩm! bái bai, xi du ờ ghen!");
                      }
                  }
              }); 
            }
        
            function save_new_purchase_price(itemid, newpuprice){
                
                $.post(base_url+"purchase/return_purchase_newprice_update/"+itemid+"/"+newpuprice,{},function(result){
                    var lonque = '';
                    if (result == 'success'){
                        lonque = '1';
                    }else {
