...
class Purchase_model extends CI_Model {
	...
	var $column_order = array( 'a.id','a.purchase_date', 'a.purchase_code','a.reference_no','a.grand_total','a.payment_status','a.created_by','b.supplier_name','b.supplier_name_en','a.paid_amount','a.purchase_status','a.return_bit'); //set column field database for datatable orderable
	var $column_search = array('a.id','a.purchase_date','a.purchase_code','a.reference_no','a.grand_total','a.payment_status','a.created_by','b.supplier_name','b.supplier_name_en','a.paid_amount','a.purchase_status','a.return_bit'); //set column field database for datatable searchable 
	...
	public function return_purchase_var_price($item_ids, $item_checkprice){
		$q1=$this->db->select('*')->from('db_items')->where("id=$item_ids")->get();
		$q1=$this->db->query("select * from db_items where id=$item_ids");
		$res1=$q1->row();
		$purchase_price = $res1->purchase_price;
		/*if ($purchase_price != $item_checkprice) {
		    return 1;
		} else {
		    return 0;
		}*/
	...
	public function return_purchase_newprice_update($item_ids, $item_checkprice){
	    
	    $q98 = $this->db->query("UPDATE db_items SET purchase_price = '$item_checkprice', price = '$item_checkprice' WHERE id=$item_ids");
	    if (!$q98) {
	        return 'error';
	    } else {
	        return 'success';
            ...
            <tr id="row_<?=$rowcount;?>" data-row='<?=$rowcount;?>'>
               ...
               <td id="td_<?=$rowcount;?>_3">
                  <div class="input-group ">
                     ...
                     <input onclick="this.select();" type="number" value="<?=$item_purchase_qty;?>" class="form-control no-padding text-center" onkeyup="calculate_tax(<?=$rowcount;?>)" id="td_data_<?=$rowcount;?>_3" name="td_data_<?=$rowcount;?>_3">
                     <span class="input-group-btn">
               ...
               <!-- Purchase Price -->
               <td onchange="check_var_price(<?=$rowcount;?>)" id="td_<?=$rowcount;?>_4"><input onclick="this.select();" type="number" name="td_data_<?=$rowcount;?>_4" id="td_data_<?=$rowcount;?>_4" class="form-control text-right no-padding only_currency text-center" onkeyup="calculate_tax(<?=$rowcount;?>)" value="<?=$item_purchase_price;?>" ></td>
		  ...
		  <div class="modal-dialog ">
		    <div class="modal-content">
		      <div class="modal-header header-custom">
		        ...
		        <h4 class="modal-title text-center">Thanh toán đơn nhập #<?php echo  $purchase_code; ?></h4>
		      </div>
		      	...
		      	<div class="row invoice-info">
			        <div class="col-sm-6 invoice-col">
			          ...
			          <address>
			            ...
			            <?php echo (!empty(trim($supplier_mobile))) ? "Liên hệ: ".$supplier_mobile."<br>" : '';?><br>
			            Hóa đơn #<?php echo  $purchase_code; ?>
			        ...
			        <div class="col-sm-6 invoice-col">
			          <address>
			            ...
			            <b>Ngày: <?php echo  show_date($purchase_date); ?></b><br>
