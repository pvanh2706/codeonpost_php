...
class Suppliers_model extends CI_Model {
	...
	var $column_order = array('a.supplier_code','a.id','a.supplier_name','a.supplier_name_en','a.mobile','a.email','a.opening_balance','a.purchase_due','a.purchase_return_due','a.status'); //set column field database for datatable orderable
	var $column_search = array('a.supplier_code','a.id','a.supplier_name','a.supplier_name_en','a.mobile','a.email','a.opening_balance','a.purchase_due','a.purchase_return_due','a.status'); //set column field database for datatable searchable 
      ...
      <div class="modal-dialog ">
        <div class="modal-content">
          <div class="modal-header header-custom">
            ...
            <h4 class="modal-title text-center">Thanh toán nợ nhập hàng</h4>
          </div>
          ...
          <div class="col-md-12">
            <div class="row invoice-info">
              <div class="col-sm-12 invoice-col">
                <i>Thông tin Nhà cung cấp</i>
                <address>
                  <strong><?php echo  $supplier_name; ?></strong> - <?php echo (!empty(trim($supplier_mobile))) ? "Liên hệ: ".$supplier_mobile : '';?><br>
              ...
              <div class="col-sm-12 invoice-col">
                ...
                <table class="table table-sm table-bordered bg-info" width="100%">
                  <tr>
                    ...
                    <td class="text-right">Tổng nhập hàng</td>
                    <td class="text-right"><?= $CI->currency(number_format($total_purchase_amount)); ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="2"></td>
                    <td class="text-right">Nợ còn lại</td>
                    <td class="text-right"><?= $CI->currency(number_format($supplier_purchase_due)); ?></td>
                  </tr>
                </table>
  ...
  public function delete_opening_balance_entry($entry_id){
    ...
    if(!empty($id)){
      ...
      $this->db->where("upper(supplier_name) like '%$q%' or upper(supplier_name_en) like '%$q%' or upper(mobile) like '%$q%'");
    }
    //$this->db->limit(10);
